...
const CoreSection = (props: { children: ReactNode; className?: string }) => {
  return (
    <div
      className={`justify-center min-w-min bordered-box-h w-full md:w-[45%] lg:w-[48%] xl:w-[30%] mb-2 ${props.className}`}
    >
      {props.children}
    </div>
  );
...
const CoreHeading = (props: { children: ReactNode }) => {
  return (
    <h2 className="justify-items-center font-legendSerif text-[35px] mb-4">
      {props.children}
    </h2>
  );
};
  ...
  return (
    <div className="py-8 sm:py-16 bg-brand-gray-100 text-brand-primary">
      <div className="container">
        <div className="section gap-8 justify-center flex flex-row flex-wrap w-full">
